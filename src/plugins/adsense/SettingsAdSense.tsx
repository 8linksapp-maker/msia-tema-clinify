  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-6">
        <h3 className="font-bold text-adm-ink mb-1">Publisher ID</h3>
        <p className="text-sm text-adm-ink-muted mb-4">
          Encontre seu Publisher ID no painel do AdSense em{' '}
          <span className="font-mono text-adm-primary">Conta → Informações da conta</span>.
      ...
      <div className="bg-adm-elev rounded-lg border border-adm-border p-4">
        <div className="flex items-center justify-between text-sm">
          ...
          {isValid ? (
            ...
            <span className="text-adm-ink-faint">{publisherId ? 'ID inválido' : 'Não configurado'}</span>
          )}
        </div>
        {isValid && (
          <div className="flex items-center justify-between text-sm mt-2">
            <span className="text-adm-ink-muted">ID ativo</span>
            <span className="font-mono font-bold text-adm-ink">{publisherId}</span>
          </div>
        )}
      </div>
