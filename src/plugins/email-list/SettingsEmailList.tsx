    ...
    return (
        <div className="max-w-2xl space-y-6">
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-5">
                <p className="text-xs font-bold text-adm-ink-muted uppercase tracking-wider mb-3">O que está ativo agora</p>
                    ...
                    {[
                        ...
                        <div
                            ...
                            className={`flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold border ${
                                item.active
                                    ? 'bg-adm-primary-soft border-adm-primary/30 text-adm-primary'
                                    : 'bg-adm-elev border-adm-border text-adm-ink-faint'
                            }`}
                        >
                            <div className={`w-1.5 h-1.5 rounded-full ${item.active ? 'bg-adm-primary' : 'bg-adm-ink-faint'}`} />
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-6">
                ...
                <button
                    ...
                    className="mt-4 flex items-center gap-2 px-4 py-2 border border-adm-border rounded-md text-sm font-medium text-adm-ink hover:bg-adm-elev disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-6">
                ...
                <div className={`space-y-4 transition-opacity ${popupEnabled ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
                    ...
                    <label className="flex items-center gap-3 cursor-pointer select-none">
                        <input
                            ...
                            className="w-4 h-4 accent-adm-primary rounded"
                        />
                        <span className="text-sm font-medium text-adm-ink">
                ...
                {/* Preview do popup */}
                {popupEnabled && (
                    <div className="mt-5 p-4 bg-adm-elev rounded-md border border-adm-border">
                        <p className="text-xs font-bold text-adm-ink-faint uppercase tracking-wider mb-3">Preview</p>
                        <div className="bg-adm-surface rounded-md p-5 shadow-sm max-w-xs mx-auto text-center border border-adm-border">
                            ...
                            <div className="space-y-2">
                                <div className="w-full h-9 bg-adm-elev rounded-lg" />
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-6">
                ...
                {sidebarEnabled && (
                    <div className="mt-5 p-4 bg-adm-elev rounded-md border border-adm-border">
                        <p className="text-xs font-bold text-adm-ink-faint uppercase tracking-wider mb-3">Preview</p>
                        <div className="bg-adm-surface rounded-md p-4 shadow-sm max-w-xs mx-auto text-center border border-adm-border">
                            ...
                            <div className="space-y-2">
                                <div className="w-full h-8 bg-adm-elev rounded-lg" />
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-6">
                ...
                {inlineEnabled && (
                    <div className="mt-5 p-4 bg-adm-elev rounded-md border border-adm-border">
                        <p className="text-xs font-bold text-adm-ink-faint uppercase tracking-wider mb-3">Preview</p>
                        <div className="bg-adm-primary-soft border border-adm-primary/30 rounded-md p-4 flex items-center gap-3">
                            ...
                            <div className="flex gap-2 shrink-0">
                                <div className="h-8 w-28 bg-adm-surface border border-adm-primary/30 rounded-lg" />
