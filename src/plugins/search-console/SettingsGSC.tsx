...
export default function SettingsGSC() {
    ...
    const inputClass = 'w-full bg-adm-surface border border-adm-border rounded-md px-4 py-3 text-sm font-medium text-adm-ink focus:outline-none focus:border-adm-primary/80 focus:ring-2 focus:ring-adm-primary/20/20 transition-all shadow-sm';
    ...
    return (
        <div className="max-w-2xl space-y-6">
            ...
            {/* Seção básica */}
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b border-adm-border bg-adm-elev">
                    <h3 className="font-bold text-adm-ink">Verificar propriedade</h3>
                    <p className="text-xs text-adm-ink-muted mt-0.5">Confirma ao Google que você é dono do site — etapa obrigatória.</p>
                </div>
                <div className="p-6 space-y-5">
                    {/* Passo 1: Verificação */}
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            <span className="w-6 h-6 bg-adm-primary-soft text-adm-primary rounded-full flex items-center justify-center text-xs font-bold shrink-0">1</span>
                            <h4 className="font-semibold text-adm-ink text-sm">Meta Tag de Verificação</h4>
                        </div>
                        <p className="text-sm text-adm-ink-muted mb-3 leading-relaxed">
                            No Search Console, vá em <strong>Configurações → Verificação de propriedade → Tag HTML</strong> e copie a tag <code className="bg-adm-elev px-1 rounded font-mono text-xs">&lt;meta name="google-site-verification" ...&gt;</code>.
                        </p>
                        <input
                            type="text"
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-3">
                            <span className="w-6 h-6 bg-adm-primary-soft text-adm-primary rounded-full flex items-center justify-center text-xs font-bold shrink-0">2</span>
                            <h4 className="font-semibold text-adm-ink text-sm">URL da Propriedade</h4>
                        </div>
                        <input
                            type="url"
                            value={siteUrl}
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm overflow-hidden">
                <button
                    ...
                    className="w-full flex items-center justify-between px-6 py-4 text-left hover:bg-adm-elev transition-colors"
                >
                    <div>
                        <p className="font-bold text-adm-ink">Conectar API para ver dados</p>
                        <p className="text-xs text-adm-ink-muted mt-0.5">Avançado — requer ajuda técnica</p>
                    </div>
                    {advancedOpen
                        ? <ChevronUp className="w-4 h-4 text-adm-ink-faint shrink-0" aria-hidden="true" />
                        : <ChevronDown className="w-4 h-4 text-adm-ink-faint shrink-0" aria-hidden="true" />}
                </button>

                {advancedOpen && (
                    <div className="px-6 pb-6 space-y-5 border-t border-adm-border pt-5">
                        {/* Aviso honesto */}
                        ...
                        <div className="bg-adm-surface border border-adm-border rounded-md p-4 space-y-3">
                            <p className="font-semibold text-adm-ink text-sm">Antes de continuar</p>
                            <p className="text-xs text-adm-ink-muted leading-relaxed">
                                O JSON do service account será salvo em <code className="bg-adm-elev px-1 rounded font-mono">pluginsConfig.json</code>. Esse arquivo contém credenciais sensíveis — o repositório precisa ser privado.
                            </p>
                            <div className="flex items-start gap-3">
                                <a
                                    ...
                                    className="flex items-center gap-1.5 text-xs font-medium text-adm-primary hover:underline shrink-0"
                                >
                            ...
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    className="rounded border-adm-border text-adm-primary focus:ring-adm-primary/20 w-4 h-4 shrink-0"
                                />
                                <span className="text-xs text-adm-ink-muted">Confirmei que o repositório é privado</span>
                            </label>
                        </div>
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-2">
                                    <span className="w-6 h-6 bg-adm-primary-soft text-adm-primary rounded-full flex items-center justify-center text-xs font-bold shrink-0">3</span>
                                    <h4 className="font-semibold text-adm-ink text-sm">Service Account (Google Cloud)</h4>
                                </div>
                                <a
                            ...
                            {/* Mini guia */}
                            <div className="bg-adm-elev rounded-md p-4 mb-4 text-xs text-adm-ink-muted space-y-1.5 leading-relaxed">
                                <p className="font-semibold text-adm-ink mb-2">Como obter o JSON:</p>
            ...
            {/* Status */}
            <div className="bg-adm-elev rounded-lg border border-adm-border p-4">
            ...
            <div className="flex gap-3">
                <button
                    ...
                    className="px-5 py-2.5 border border-adm-border rounded-md text-sm font-medium text-adm-ink hover:bg-adm-elev disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
                >
                ...
                <button
                    ...
                    onClick={handleSave}
                    disabled={saving}
                    className="bg-adm-primary hover:bg-adm-primary disabled:opacity-50 text-white px-6 py-2.5 rounded-md text-sm font-bold flex items-center gap-2 transition-all shadow-sm shadow-none/20"
                >
