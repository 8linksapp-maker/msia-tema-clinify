...
function getTagType(id: string): { label: string; color: string; bg: string } {
    ...
    return { label: 'Outro', color: 'text-adm-ink', bg: 'bg-adm-elev' };
}
...
export default function SettingsGoogleTag() {
    ...
    const inputClass = 'flex-1 bg-adm-surface border border-adm-border rounded-md px-4 py-3 text-sm font-medium text-adm-ink focus:outline-none focus:border-adm-primary/80 focus:ring-2 focus:ring-adm-primary/20/20 transition-all shadow-sm font-mono';
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-6">
                ...
                {tags.length === 0 ? (
                    <div className="text-center py-8 text-adm-ink-faint">
                        ...
                        <p className="text-sm font-medium text-adm-ink-muted mb-1">Conecte o Google Analytics para ver as visitas do seu site.</p>
                        <a
                            href="https://support.google.com/analytics/answer/9304153"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-xs text-adm-primary font-semibold hover:underline"
                        >
                    ...
                    <div className="space-y-2 mb-4">
                        {tags.map(id => {
                            ...
                            return (
                                <div key={id} className="flex items-center justify-between bg-adm-elev rounded-md px-4 py-3 border border-adm-border">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={addTag}
                        className="bg-adm-primary hover:bg-adm-primary text-white px-4 py-3 rounded-md text-sm font-bold flex items-center gap-2 transition-all shadow-sm shadow-none/20 shrink-0"
                    >
