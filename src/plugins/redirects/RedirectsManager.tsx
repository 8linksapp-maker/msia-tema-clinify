...
export default function RedirectsManager() {
  ...
  const inputClass = 'w-full bg-adm-surface border border-adm-border rounded-md px-4 py-3 text-sm font-medium text-adm-ink focus:outline-none focus:border-adm-primary/80 focus:ring-2 focus:ring-adm-primary/20/20 transition-all shadow-sm font-mono';
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={handleAdd}
          className="bg-adm-primary hover:bg-adm-primary text-white px-4 py-2.5 rounded-md text-sm font-bold flex items-center gap-2 transition-all"
        >
      ...
      {/* Add/Edit Form */}
      {showForm && (
        <div className="bg-adm-surface rounded-lg border border-adm-primary/30 shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-3 cursor-pointer p-3 bg-adm-elev rounded-md hover:bg-adm-primary-soft transition-colors w-fit">
              <input
                type="checkbox"
              ...
              />
              <span className="text-sm font-medium text-adm-ink">Ativo</span>
            </label>
            ...
            <div className="flex gap-3 pt-2">
              <button
                ...
                disabled={saving}
                className="bg-adm-primary hover:bg-adm-primary disabled:opacity-50 text-white px-5 py-2.5 rounded-md text-sm font-bold flex items-center gap-2 transition-all"
              >
      ...
      {/* Redirects list */}
      {redirects.length === 0 ? (
        <div className="bg-adm-surface rounded-lg border border-adm-border p-12 text-center">
        ...
        <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-adm-elev border-b border-adm-border">
              <tr>
                ...
                <tr key={r.id} className={`${!r.enabled ? 'opacity-40' : ''} hover:bg-adm-elev transition-colors`}>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <code className="text-xs bg-adm-elev px-2 py-0.5 rounded text-adm-ink">{r.from}</code>
