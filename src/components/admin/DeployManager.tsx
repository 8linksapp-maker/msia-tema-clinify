...
export default function DeployManager() {
    ...
    if (ui === 'not_configured') {
        return (
            <div className="bg-adm-elev border border-adm-border rounded-md px-4 py-3 mb-6 flex items-center gap-3">
                <AlertCircle className="w-5 h-5 text-adm-ink-muted shrink-0" />
                <p className="text-sm text-adm-ink">
    ...
    if (ui === 'snoozed') {
        ...
        return (
            <div className="bg-adm-elev border border-adm-border rounded-md px-4 py-2.5 mb-6 flex items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                    <Clock className="w-4 h-4 text-adm-ink-muted shrink-0" />
                ...
                <button onClick={unsnooze} className="text-xs font-medium text-adm-primary hover:text-violet-900 underline">Mostrar agora</button>
            </div>
        );
    }
