    ...
    return (
        <div className="max-w-4xl pb-32">
            <div className="flex items-center justify-between bg-adm-surface p-4 px-6 rounded-lg border border-adm-border shadow-sm mb-6">
                <div>
                    <h2 className="text-lg font-bold text-adm-ink">Editar Página: Contato</h2>
                    <p className="text-xs text-adm-ink-muted mt-0.5">Edita o arquivo <code className="bg-adm-elev px-1 rounded">src/data/contato.json</code></p>
                </div>
            ...
            <form onSubmit={handleSave} className="space-y-6">
                <div className={cardClass}>
                    <h3 className="text-lg font-bold text-adm-ink mb-6 border-b border-adm-border pb-4">1. Chamada de Topo (Hero)</h3>
                ...
                <div className={cardClass}>
                    <div className="flex items-center justify-between mb-4 pb-2 border-b border-adm-border">
                        <h3 className="text-lg font-bold text-adm-ink">2. Textos do Bloco de Informações</h3>
                        <span className="text-[10px] bg-adm-elev text-adm-ink font-bold px-2 py-1 rounded">Contatos reais editados em Configurações</span>
                    </div>
                ...
                <div className={cardClass}>
                    <h3 className="text-lg font-bold text-adm-ink mb-6 border-b border-adm-border pb-4">3. Google Maps</h3>
                    <div className="space-y-4">
                        <div>
                            ...
                            <p className="text-xs text-adm-ink-faint mt-1">Google Maps &rarr; Compartilhar &rarr; Incorporar &rarr; copie a URL do src=""</p>
                        </div>
                    </div>
                </div>
