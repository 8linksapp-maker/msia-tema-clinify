...
export default function MenuEditor() {
    ...
    if (loading) return (
        <div className="flex items-center justify-center h-64 gap-3 text-adm-ink-muted">
            <Loader2 className="w-5 h-5 animate-spin text-adm-primary" />
        ...
        <div className="max-w-2xl space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-md bg-adm-primary-soft flex items-center justify-center">
                ...
                <button
                    onClick={save}
                    disabled={saving}
                    className="flex items-center gap-2 px-4 py-2 bg-adm-primary text-white text-sm font-bold rounded-md hover:bg-adm-primary disabled:opacity-60 transition-all shadow-sm"
                >
            ...
            <div className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-4 flex items-start gap-3">
                <div className="w-10 h-10 rounded-md bg-adm-primary-soft flex items-center justify-center shrink-0">
                ...
                <div className="flex-1">
                    <div className="flex items-center justify-between gap-3">
                        ...
                        <button
                            ...
                            className={`relative w-11 h-6 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-adm-primary/30 focus:ring-offset-2 shrink-0 ${
                                menuHoverEnabled ? 'bg-adm-primary' : 'bg-adm-elev border border-adm-border'
                            }`}
                        >
                            <span aria-hidden="true" className={`absolute top-0.5 left-0.5 w-5 h-5 bg-adm-surface rounded-full shadow transition-transform duration-200 ${
            ...
            {/* Info */}
            <div className="bg-adm-primary-soft border border-adm-border rounded-md p-4 text-sm text-adm-primary">
            ...
            <div className="space-y-3">
                {items.length === 0 && (
                    <div className="text-center py-12 bg-adm-surface rounded-lg border border-dashed border-adm-border">
                        <LayoutList className="w-8 h-8 text-adm-ink-faint mx-auto mb-2" />
                ...
                {items.map((item, i) => (
                    <div key={i} className="bg-adm-surface rounded-lg border border-adm-border shadow-sm p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex flex-col gap-0.5 pt-0.5 shrink-0">
                                <button
                                    ...
                                    disabled={i === 0}
                                    className="w-10 h-10 min-h-[44px] min-w-[44px] rounded flex items-center justify-center text-adm-ink-faint hover:text-adm-ink hover:bg-adm-elev disabled:opacity-30 disabled:cursor-not-allowed transition-all"
                                >
                            ...
                            <div className="flex-1 grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ex: Blog"
                                        className="w-full px-3 py-2 border border-adm-border rounded-md text-sm text-adm-ink focus:outline-none focus:ring-2 focus:ring-adm-primary/20/20 focus:border-adm-primary/60 transition-all"
                                    />
                                </div>
                                <div>
                                    <label className="block text-xs font-bold text-adm-ink-muted uppercase tracking-widest mb-1">
                            ...
                            <button
                                ...
                                className="mt-1 w-10 h-10 min-h-[44px] min-w-[44px] rounded flex items-center justify-center text-adm-ink-faint hover:text-red-600 hover:bg-red-50 transition-all shrink-0"
                            >
                        ...
                        <div className="mt-3 ml-10 flex items-center gap-2">
                            <button
                                ...
                                className={`relative w-9 h-5 rounded-full transition-colors duration-200 focus:outline-none ${
                                    item.showCategories ? 'bg-adm-primary' : 'bg-adm-elev'
                                }`}
                            >
                                <span className={`absolute top-0.5 left-0.5 w-4 h-4 bg-adm-surface rounded-full shadow transition-transform duration-200 ${
            ...
            <button
                onClick={addItem}
                className="w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-adm-border rounded-lg text-sm font-medium text-adm-ink-muted hover:text-adm-primary hover:border-adm-primary/40 hover:bg-adm-primary-soft transition-all"
            >
